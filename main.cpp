...
Microsoft::WRL::ComPtr<IDxcBlob> CompileShader(
	...
	LPCWSTR arguments[] = {
	    ...
	    L"-E",
	    L"main", // エントリーポイントの指定。基本的にmain以外はしない
	    L"-T",
	    profile, // ShaderProfileの指定
	    L"-Zi",
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	*//////////////////////////////////////////////////////////////////////////////
	...
	// データを書き込む
	CameraForGPU* transformationMatrixDataPhong = nullptr;
	// 書き込むためのアドレスを取得
	transformationMatrixResourcePhong->Map(0, nullptr, reinterpret_cast<void**>(&transformationMatrixDataPhong));
	// 単位行列を書き込んでおく
	transformationMatrixDataPhong->worldPosition = {0.0f, 4.0f, -10.0f};
	...
	while (msg.message != WM_QUIT) {
		...
		if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE)) {
			...
			*//////////////////////////////////////////////////////////////////////////////
			...
			// wvp用のCBufferの場所を設定
			commandList->SetGraphicsRootConstantBufferView(1, wvpResouceSphere->GetGPUVirtualAddress());
			//
			commandList->SetGraphicsRootConstantBufferView(3, materialResourceLight->GetGPUVirtualAddress());
			commandList->SetGraphicsRootConstantBufferView(4, transformationMatrixResourcePhong->GetGPUVirtualAddress());
